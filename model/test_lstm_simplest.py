...
from constants import NUM_LSTM_CELLS_PER_HIDDEN_LAYER, NUM_LSTM_HIDDEN_LAYERS
from model.handwriting_prediction import SimpleHandwritingPredictionModel, SimplestHandwritingPredictionModel
import numpy as np
...
create_gif("lstm_cosine/cosine_wave_prediction", "epoch_*_real", "variable_length_peephole_lstm", fps=5)
create_gif("lstm_cosine/cosine_wave_prediction/saved", "epoch_*_real", "same_length_peephole_lstm", fps=5)
